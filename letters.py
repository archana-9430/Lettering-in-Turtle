...
#################################
def draw_D(x = 0, y = 0, color = "white", bg_color = "black"):
    hi.color(color)
    s.bgcolor(bg_color)
    hi.up()
    hi.goto(x, y)
...
def draw_E(x = 0, y = 0, color = "white", bg_color = "black"):
    hi.color(color)
    s.bgcolor(bg_color)
    hi.up()
    hi.goto(x, y)
...
def draw_H(x = 0, y = 0, color = "white", bg_color = "black"):
    hi.color(color)
    s.bgcolor(bg_color)
    hi.color("blue")
    hi.up()
...
def draw_p(x = 0, y = 0, color = "white", bg_color = "black"):
    hi.color(color)
    s.bgcolor(bg_color)
    hi.up()
    hi.goto(x, y)
...
def draw_R(x = 0, y = 0, color = "white", bg_color = "black"):
    hi.color(color)
    s.bgcolor(bg_color)
    hi.up()
    hi.goto(x, y)
...
def draw_T(x = 0, y = 0, color = "white", bg_color = "black"):
    hi.color(color)
    s.bgcolor(bg_color)
    hi.up()
    hi.goto(x, y)
